...
const styles = StyleSheet.create({
  ...
  logoImage: { width: 76, height: 44, objectFit: "contain" },
...
type RdoPdf = { date: string; status: string; weather_morning: string; weather_afternoon: string; notes: string | null; projects: { name: string; address: string; logo_url?: string | null }; rdo_labor: Item[]; rdo_equipment: Item[]; rdo_activities: Item[]; rdo_occurrences: Item[] };
